...
/* @var $searchModel app\models\VehTestReportDetailSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Veh Test Report Details';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="veh-test-report-detail-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' Veh Test Report Details','class' => 'btn btn-outline-primary']).
