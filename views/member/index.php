...
/* @var $searchModel app\models\UserReqSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'User Reqs';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="user-req-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar' => [
                ['content'=>
                    ...
                    ['role' => 'modal-remote', 'title' => Yii::t('yii2-ajaxcrud', 'Create New').' User Reqs','class' => 'btn btn-outline-primary']).
